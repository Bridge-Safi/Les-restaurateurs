...
// PORT/BASE_PATH ne servent qu'au serveur dev/preview, pas a `vite build`.
// Railway ne fournit PORT qu'au runtime (pas au build), donc on met des
// valeurs par defaut ici pour ne pas faire planter le build.
